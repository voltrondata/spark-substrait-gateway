...
def mark_tests_as_xfail(request):
    ...
    if source == 'gateway-over-duckdb' and originalname in [
        'test_query_02', 'test_query_08', 'test_query_09']:
    ...
    if source == 'gateway-over-duckdb' and originalname in [
        'test_query_03', 'test_query_05', 'test_query_07', 'test_query_10', 'test_query_11',
        'test_query_12', 'test_query_15', 'test_query_16', 'test_query_17', 'test_query_18',
