...
SPARK_SUBSTRAIT_MAPPING = {
    "split": ExtensionFunction(
        ...
        "string_split:str_str",
        type_pb2.Type(
            string=type_pb2.Type.String(nullability=type_pb2.Type.Nullability.NULLABILITY_REQUIRED)
        ),
        max_args=2,
    ),
    "==": ExtensionFunction(
        ...
        "equal:str_str",
        type_pb2.Type(
            bool=type_pb2.Type.Boolean(nullability=type_pb2.Type.Nullability.NULLABILITY_REQUIRED)
        ),
    ),
    "equal_null": ExtensionFunction(
        "/functions_comparison.yaml",
        "is_not_distinct_from:str_str",
        type_pb2.Type(
            bool=type_pb2.Type.Boolean(nullability=type_pb2.Type.Nullability.NULLABILITY_REQUIRED)
        ),
    ),
    ...
    "<=>": ExtensionFunction(
        "/functions_comparison.yaml",
        "is_not_distinct_from:any_any",
        type_pb2.Type(
            bool=type_pb2.Type.Boolean(nullability=type_pb2.Type.Nullability.NULLABILITY_NULLABLE)
        ),
    ),
    ...
    "sum": ExtensionFunction(
        ...
        "sum:int",
        type_pb2.Type(
            i32=type_pb2.Type.I32(nullability=type_pb2.Type.Nullability.NULLABILITY_REQUIRED)
        ),
    ...
    "sqrt": ExtensionFunction(
        ...
        "sqrt:fp64",
        type_pb2.Type(
            fp64=type_pb2.Type.FP64(nullability=type_pb2.Type.Nullability.NULLABILITY_REQUIRED)
        ),
    ...
    "regexp_substring": ExtensionFunction(
        "/functions_string.yaml",
        "regexp_substring:str_str_i64_i64",
        type_pb2.Type(
            i64=type_pb2.Type.I64(nullability=type_pb2.Type.Nullability.NULLABILITY_REQUIRED)
        ),
    ),
    ...
    "coalesce": ExtensionFunction(
        ...
        "coalesce:any",
        type_pb2.Type(
            string=type_pb2.Type.String(nullability=type_pb2.Type.Nullability.NULLABILITY_NULLABLE)
        ),
    ),
    ...
    "struct_extract": ExtensionFunction(
        "/functions_structs.yaml",
        "struct_extract:any_str",
        type_pb2.Type(
            i64=type_pb2.Type.I64(nullability=type_pb2.Type.Nullability.NULLABILITY_REQUIRED)
        ),
    ),
