...
def project_relation(
    input_relation: algebra_pb2.Rel, expressions: list[algebra_pb2.Expression]
) -> algebra_pb2.Rel:
...
def aggregate_relation(
    input_relation: algebra_pb2.Rel, measures: list[algebra_pb2.AggregateFunction]
) -> algebra_pb2.Rel:
    ...
    aggregate = algebra_pb2.Rel(
        aggregate=algebra_pb2.AggregateRel(
            common=algebra_pb2.RelCommon(
                emit=algebra_pb2.RelCommon.Emit(output_mapping=range(len(measures)))
            ),
    ...
    for measure in measures:
        aggregate.aggregate.measures.append(algebra_pb2.AggregateRel.Measure(measure=measure))
    return aggregate
...
def join_relation(left: algebra_pb2.Rel, right: algebra_pb2.Rel) -> algebra_pb2.Rel:
    ...
    return algebra_pb2.Rel(
        join=algebra_pb2.JoinRel(
            ...
            left=left,
            right=right,
            expression=algebra_pb2.Expression(literal=algebra_pb2.Expression.Literal(boolean=True)),
...
def concat(
    function_info: ExtensionFunction, expressions: list[algebra_pb2.Expression]
    ...
    return algebra_pb2.Expression(
        scalar_function=algebra_pb2.Expression.ScalarFunction(
            ...
            arguments=[
                algebra_pb2.FunctionArgument(value=expression) for expression in expressions
            ],
        )
    )
...
def strlen(
    function_info: ExtensionFunction, expression: algebra_pb2.Expression
) -> algebra_pb2.Expression:
    """Construct a Substrait concat expression."""
    return algebra_pb2.Expression(
        scalar_function=algebra_pb2.Expression.ScalarFunction(
...
def cast_operation(
    expression: algebra_pb2.Expression, output_type: type_pb2.Type
) -> algebra_pb2.Expression:
...
def if_then_else_operation(
    if_expr: algebra_pb2.Expression,
    then_expr: algebra_pb2.Expression,
    else_expr: algebra_pb2.Expression,
) -> algebra_pb2.Expression:
    ...
    return algebra_pb2.Expression(
        selection=algebra_pb2.Expression.FieldReference(
            direct_reference=algebra_pb2.Expression.ReferenceSegment(
                struct_field=algebra_pb2.Expression.ReferenceSegment.StructField(field=field_number)
            ),
...
def max_agg_function(
    function_info: ExtensionFunction, field_number: int
...
def string_concat_agg_function(
    function_info: ExtensionFunction, field_number: int, separator: str = ""
) -> algebra_pb2.AggregateFunction:
    ...
    return algebra_pb2.AggregateFunction(
        ...
        output_type=function_info.output_type,
        arguments=[
            algebra_pb2.FunctionArgument(value=field_reference(field_number)),
...
def least_function(
    greater_function_info: ExtensionFunction,
    expr1: algebra_pb2.Expression,
    expr2: algebra_pb2.Expression,
) -> algebra_pb2.Expression:
    """Construct a Substrait min expression."""
    return if_then_else_operation(
        greater_function(greater_function_info, expr1, expr2), expr2, expr1
    )
...
def greatest_function(
    ...
    return if_then_else_operation(
        greater_function(greater_function_info, expr1, expr2), expr1, expr2
    )


def equal_function(
    function_info: ExtensionFunction, expr1: algebra_pb2.Expression, expr2: algebra_pb2.Expression
) -> algebra_pb2.Expression:
    """Construct a Substrait min expression."""
    return algebra_pb2.Expression(
        scalar_function=algebra_pb2.Expression.ScalarFunction(
            ...
            output_type=function_info.output_type,
            arguments=[
                algebra_pb2.FunctionArgument(value=expr1),
...
def add_function(
    ...
    """Construct a Substrait add expression."""
    return algebra_pb2.Expression(
        scalar_function=algebra_pb2.Expression.ScalarFunction(
            function_reference=function_info.anchor,
            output_type=function_info.output_type,
...
def repeat_function(
    function_info: ExtensionFunction, string: str, count: algebra_pb2.Expression
) -> algebra_pb2.Expression:
    """Construct a Substrait concat expression."""
    return algebra_pb2.Expression(
        scalar_function=algebra_pb2.Expression.ScalarFunction(
            ...
            output_type=function_info.output_type,
            arguments=[
                algebra_pb2.FunctionArgument(value=string_literal(string)),
...
def lpad_function(
    function_info: ExtensionFunction,
    expression: algebra_pb2.Expression,
    count: algebra_pb2.Expression,
    pad_string: str = " ",
) -> algebra_pb2.Expression:
    """Construct a Substrait concat expression."""
